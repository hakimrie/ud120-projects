...
min_exercised_stock_options = sys.maxint
max_salary = 0
...
print "min excercised stock options: %s max = %s" % (min_exercised_stock_options, max_exercised_stock_options)
print "min salary : %s max = %s" % (min_salary, max_salary)
